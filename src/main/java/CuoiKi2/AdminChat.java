...
protected boolean disButton;
    ...
    public ArrayList<User> userList(){
        ...
        String query = "SELECT usname,status FROM [user] WHERE class = 0 ";
        try{
            ps = conn.prepareStatement(query);
            rs = ps.executeQuery();
            User user;
            while(rs.next()){
                user = new User(rs.getString("usname"),rs.getString("status"));
                userList.add(user);
            }
        } catch(Exception e){
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Online Employee");
...
//        String query="SELECT usname FROM [user] WHERE usname =? AND class = 0";
//        try{
//            ps = conn.prepareStatement(query);
//            ps.setString(1, name);
//            rs = ps.executeQuery();
...
//                } catch (IOException e) {
//                    e.printStackTrace(); // In ra ngoại lệ để debug
//                }
//                }
      ...
      new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                while (!line.equalsIgnoreCase("end") ){//&& disButton) {
                    line = in.readUTF();
                    final String finalLine = line;
                    // Update chatTextArea on EDT
