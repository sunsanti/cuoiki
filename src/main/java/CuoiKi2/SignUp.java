...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtotp.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 2, 1, new java.awt.Color(104, 104, 104)));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtotp, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel14))
                .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(p==0){
            String sql ="INSERT INTO [user](usname,pass,fname,lname,phone,sq,answer,email,class,status) VALUES (?,?,?,?,?,?,?,?,?,'off')";
            try {
                if (txtuser.getText().trim().equals("") || txtFname.getText().trim().equals("") || txtLname.getText().trim().equals("") || txtphone.getText().trim().equals("") || txtans.getText().trim().equals("") || txtemail.getText().trim().equals("") || String.valueOf(textpass.getPassword()).trim().equals("")) {
                    ...
                    int otp2 = Integer.parseInt(txtotp.getText());
                    if (otp != otp2) {JOptionPane.showMessageDialog(null, "Wrong OTP!");}
                    else if (ps.executeQuery().next()) {JOptionPane.showMessageDialog(null, "This Username Already Used");}
    ...
    private void SendOTPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SendOTPActionPerformed
        ...
        GetEmailSender ges = new GetEmailSender(emailadd, otp);
        //if (ges.GetEmail(emailadd, otp) == true) {
        //    SendOTP.setEnabled(false);
        //    txtemail.setEditable(true);
        //    if(count == countThread.dem){
